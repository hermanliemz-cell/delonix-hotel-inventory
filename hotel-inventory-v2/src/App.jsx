  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 p-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-blue-300 text-xs mt-4">v2.0.0 &copy; 2026 Delonix Group</p>
      </div>
    </div>
  );
}
              ...
              {selectedOrg && (() => {
                ...
                return (
                  <div className="min-w-0 overflow-hidden">
                    ...
                    <p className="text-[10px] text-gray-400 leading-none hidden sm:block">v2.0.0</p>
                  </div>
                );
              })()}
            </div>
